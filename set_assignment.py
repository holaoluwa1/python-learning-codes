...
fruit = {"air", "water", "food"}
print(f"it is {'food' in fruit} food is in fruit ")
...
letters = {"a", "b", "c"}
another_set = {"b", "c", "d"}
diff = letters.difference(another_set)
print(diff)
print(letters.symmetric_difference(another_set))
